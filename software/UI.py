...
class FourQuadrantApp:
    def __init__(self, root):
        ...
        # Fix Q1 label size to frame and prevent automatic expansion
        ...
        # Buttons
        self.q4_clear_history_button = tk.Button(self.q4_frame, text="Clear Logs", command=self.clear_logs)
        self.q4_clear_history_button.grid(row=4, column=0, sticky="ew", padx=5, pady=2)
        self.q4_toggle_detection_button = tk.Button(self.q4_frame, text="Toggle Detection", command=self.toggle_detection)
        self.q4_toggle_detection_button.grid(row=5, column=0, sticky="ew", padx=5, pady=2)
        self.q4_toggle_boxes_button = tk.Button(self.q4_frame, text="Toggle Boxes", command=self.toggle_boxes)
        self.q4_toggle_boxes_button.grid(row=6, column=0, sticky="ew", padx=5, pady=2)
        self.q4_screenshot_button = tk.Button(self.q4_frame, text="Screenshot", command=self.take_screenshot)
